...
export function CommandSearch({ open, onOpenChange }: CommandSearchProps) {
  ...
  const searchItems: SearchItem[] = [
    // Principal
    { title: "Oportunidades", url: "/oportunidades", group: "Principal", icon: LayoutDashboard },
    { title: "Dashboard", url: "/oportunidades/dashboard", group: "Principal", icon: LayoutPanelLeft },

    // Administração
    { title: "Configurações", url: "/configuracoes", group: "Administração", icon: Settings },
  ]
